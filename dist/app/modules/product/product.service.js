...
const getAllProductsFromDB = (query) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const products = yield contact_model_1.Contact.find(filterOptions);
    return products;
});
...
const getAllProductsByIdFromDB = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield contact_model_1.Contact.find({ createdBy: id });
    return result;
});
const updateProductFromDB = (id, updatedProductData) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield contact_model_1.Contact.findByIdAndUpdate(id, modifiedUpdatedData, {
        new: true,
        runValidators: true,
    });
    return result;
...
const duplicateProductFromDB = (id, duplicateProductData) => __awaiter(void 0, void 0, void 0, function* () {
    const existingProduct = yield contact_model_1.Contact.findById(id);
    if (!existingProduct) {
        throw new AppError_1.default(http_status_1.default.NOT_FOUND, 'Product not found');
    }
    const productObject = existingProduct.toObject();
    // Duplicate the product by creating a new
    const duplicatedProduct = new contact_model_1.Contact(Object.assign(Object.assign(Object.assign({}, productObject), { _id: new mongoose_1.default.Types.ObjectId(), name: `${existingProduct.name}` }), duplicateProductData));
...
const bulkDeletedProductFromDB = (productsId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield contact_model_1.Contact.deleteMany({ _id: { $in: productsId } });
